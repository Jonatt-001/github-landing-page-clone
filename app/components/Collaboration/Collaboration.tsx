    ...
    <div className='max-w-[1280px] mx-auto'>
      <div className='flex md:pl-7 space-x-3 md:space-x-10'>
            ...
            <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{delay:0.6, type:'tween'}} className='md:w-10/12 mb-24'>
                <h2 className="text-[20px] md:text-2xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '200ms'}}>Stay in control</h2>  
                <h3 className="text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '300ms'}}>
                    <span className="text-[#ffa28b]">Keep project work moving wherever you are.</span>
                     Gee Mobile is designed for developers who need to manage software work beyond a traditional desktop setup. Keep context close, inspect what matters and move projects forward from your phone.
                </h3>
            </motion.div>
        </div>
            ...
            <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>Gee Mobile Workspace</span>  Bring the essential parts of your software workflow together in a mobile-first workspace built for project work on the move.</p>
                        <div>
                        <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://geemobile.geefox.xyz/" className='py-1 inline-block text-xl text-white font-semibold'>
                            Explore mobile project workflows
                ...
                <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='-400px'>
                    <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>Gee Mobile</span>   Work with your projects from your phone when you need to inspect files, make changes, manage assets or keep development moving.</p>
                        <div>
                            <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://geemobile.geefox.xyz/" className='py-1 inline-block text-xl text-white font-semibold'>
                                Open Gee Mobile
        ...
        <HoverCard backgroundColor='#ffa28b' direction='' left=''>
          <div className='md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between'>
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Project access</span>  Keep important project operations within reach while you work away from your main development machine.</p>
              <div>
                <a onMouseEnter={() => setHovered2(true)} onMouseLeave={() => setHovered2(false)} href="https://geemobile.geefox.xyz/" className='py-1 inline-block text-xl text-white font-semibold'>
                    Open Gee Mobile
          ...
          <div className='overflow-hidden rounded-s-lg z-[1] flex-1'>
              <motion.div variants={container} initial='hidden' whileInView='show'  className='flex flex-wrap w-full relative -top-[120px] -rotate-12 -right-6 -mt-6  p-6 max-h-[480px]'>
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className="d-block rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Project files</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              ...
                              <span className="Button-label text-[#c9d1d9]">Explore</span>
                            </span>
                        </button>
                      </a>
                  </motion.div>
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Asset management</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Mobile editing</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Environment control</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Deployment workflow</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Project inspection</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Release checks</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">Workspace tools</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
                  ...
                  <motion.div variants={item} transition={{type:'tween'}} className='w-1/3 '>
                      <a href="https://geemobile.geefox.xyz/" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                        <img alt="Gee Mobile workflow preview" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/2.png" />
                        <div className="text-[#7d8590] my-2">GeeFox ecosystem</div>
                        <button type="button" className=' bg-[#21262d] rounded-md '>
                            <span className='flex items-center justify-between px-2 py-1 space-x-2'>
                              <svg aria-hidden="true" height="16" viewBox="0 0 16 16" fill='currentColor' version="1.1" width="16" data-view-component="true" className="octicon octicon-heart text-[#c9d1d9]">
                                  <path d="m8 14.25.345.666a.75.75 0 0 1-.69 0l-.008-.004-.018-.01a7.152 7.152 0 0 1-.31-.17 22.055 22.055 0 0 1-3.434-2.414C2.045 10.731 0 8.35 0 5.5 0 2.836 2.086 1 4.25 1 5.797 1 7.153 1.802 8 3.02 8.847 1.802 10.203 1 11.75 1 13.914 1 16 2.836 16 5.5c0 2.85-2.045 5.231-3.885 6.818a22.066 22.066 0 0 1-3.744 2.584l-.018.01-.006.003h-.002ZM4.25 2.5c-1.336 0-2.75 1.164-2.75 3 0 2.15 1.58 4.144 3.365 5.682A20.58 20.58 0 0 0 8 13.393a20.58 20.58 0 0 0 3.135-2.211C12.92 9.644 14.5 7.65 14.5 5.5c0-1.836-1.414-3-2.75-3-1.373 0-2.609.986-3.029 2.456a.749.749 0 0 1-1.442 0C6.859 3.486 5.623 2.5 4.25 2.5Z"></path>
