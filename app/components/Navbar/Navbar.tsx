        ...
        <div className='flex items-center max-lg:justify-between max-lg:flex-row-reverse'>
            <div className='flex justify-between items-center max-lg:w-full'>
                <div className='lg:hidden'>
                        <a href="https://geemobile.geefox.xyz/" className='px-2 py-[6px] border-[1px] rounded-md hover:text-neutral-400'>Open</a>
                </div>
                <a className='flex items-center gap-2' href="https://geemobile.geefox.xyz/" aria-label="Gee Mobile home">
                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-white text-[#0d1117] font-black text-sm">G</span>
                    <span className="font-semibold text-[18px] tracking-tight">Gee Mobile</span>
                </a>
                ...
                <div className='flex max-lg:flex-col lg:items-center lg:justify-between max-lg:justify-between max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:w-full max-lg:max-h-[500px]  overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg'>
                    ...
                    <div className='lg:flex items-center max-lg:flex-col lg:px-0 px-3 mb-3 lg:mb-0 text-left lg:space-x-4'>
                        <div className='lg:flex mb-2 lg:mb-0 relative max-lg:mr-4'>
                            <input placeholder='Search Gee Mobile' className='glass max-lg:bg-neutral-50 max-lg:w-full  w-[240px] lg:px-2 h-[38px] max-lg:h-[41px] p-[3.5px] whitespace-nowrap overflow-hidden placeholder:text-[14px] max-lg:placeholder:text-[16px] font-medium placeholder:pl-2 focus:z-10 text-[14px] focus:outline-none focus:bg-white focus:text-black border-[1px] lg:border-neutral-500 max-lg:border-neutral-300 rounded-md' type='text' />
                        ...
                        <div className='max-lg:flex justify-center max-lg:border-[1px] max-lg:mr-4 rounded-md max-lg:bg-neutral-800'>
                            <a href="https://geemobile.geefox.xyz/" className='hover:text-neutral-400 max-lg:py-2 max-lg:text-[16px] max-lg:font-semibold '>Sign in</a>
                        </div>
                        <a href="https://geemobile.geefox.xyz/" className='max-lg:hidden px-2 py-[5px] border-[1px] rounded-md hover:text-neutral-400 '>Sign up</a>
                    </div>
                </div>
            </div>
        </div>
