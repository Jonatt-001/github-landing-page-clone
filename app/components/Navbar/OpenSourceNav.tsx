        ...
        <li id='myLi'  onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
            ...
            <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[320px] transition ease-in duration-150 ${show ? "opacity-100 visible" : "opacity-0 hidden"}`}>
                <div className='lg:border-b-[1px] mb-4 pb-6 pt-4 w-full'>
                    <span className='text-neutral-800 font-semibold text-base hover:text-blue-600'> GeeFox ecosystem <p className='text-sm font-normal text-neutral-500'>Explore the GeeFox developer ecosystem</p></span>
                </div>
                <div className='lg:border-b-[1px] mb-4 pb-6 pt-0 w-full'>
                    <span className='text-neutral-800 font-semibold text-base hover:text-blue-600'>Developer resources <p className='text-sm font-normal text-neutral-500'>Product notes and developer resources</p></span>
                </div>
                <div className='mb-4 pb-0 pt-2 w-full'>
                    <span className='text-neutral-800 font-semibold text-base'>Projects</span>
                    <ul className='text-sm text-neutral-500 mt-1 w-full'>
                        <li >
                            <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Features</a>
                        </li>
                        <li >
                            <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Workflows</a>
                        </li>
                        <li >
                            <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Resources</a>
                        </li>
                    </ul>
                </div>
            </div>
