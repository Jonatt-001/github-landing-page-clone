        ...
        <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[300px] transition ease-in duration-300 ${show ? "opacity-100 " : "opacity-0 hidden top-[2000px]"}`}>
            <div className='lg:border-b-[1px] mb-4 pb-4 pt-4 w-full'>
                ...
                <ul className='text-sm text-neutral-500 mt-1 w-full'>
                    <li >
                        <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Project workflows</a>
                    </li>
                    <li>
                        <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Mobile teams</a>
                    </li>
                    <li >
                        <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Independent builders</a>
                    </li>
                    <li className='py-2'>
            ...
            <div className='lg:border-b-[1px] mb-4 pb-4 pt-2 w-full'>
                <span className='text-neutral-800 font-semibold text-base'>By workflow</span>
                <ul className='text-sm text-neutral-500 mt-1 w-full'>
                    <li >
                        <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Deploy & maintain</a>
                    </li>
                    <li className='py-2'>
            ...
            <div className='mb-4 pb-0 pt-2 w-full'>
                ...
                <ul className='text-sm text-neutral-500 mt-1 w-full'>
                    <li >
                        <a href="https://geemobile.geefox.xyz/" className='block py-2 hover:text-blue-600'>Developer workflows</a>
                    </li>
                    <li className='py-2'>
