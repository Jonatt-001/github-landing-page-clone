...
const Globe = (props: Props) => {
  ...
  return (
    ...
    <div className='max-w-[1280px] mx-auto relative z-[2]'>
      <div className='flex my-8 md:my-16 sm:my-12 relative md:items-center text-center flex-col'>
          <div className='py-3 mb-2 flex flex-col justify-center items-center'>
            <h2 className='px-4 mb-4 md:w-9/12 mx-auto lg:text-5xl md:text-4xl text-3xl font-bold text-white'>Your developer workspace, wherever you are</h2>
            <p className="mb-4 md:text-xl text-[16px] text-[#7d8590] px-4 mx-auto md:w-7/12">Gee Mobile gives developers a mobile-first place to build, inspect, edit, deploy and maintain software from a phone. Keep your workflow moving when your desktop is not within reach.</p>
            <div className='lg:ml-5 flex items-center justify-center lg:space-x-5 max-lg:space-y-3 max-lg:flex-col max-lg:w-full max-lg:mt-5'>
              <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://geemobile.geefox.xyz/" className='flex items-center bg-white font-bold px-14 py-3 justify-center rounded-md text-[20px]'>
                Open Gee Mobile
              ...
              <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://geemobile.geefox.xyz/" className='flex items-center text-white font-bold justify-center space-x-2 text-[20px]  border-[1px] border-neutral-500 px-4 py-3 rounded-md'>
                Explore Gee Mobile
    ...
    <img className="absolute bottom-0 left-0 w-full h-full object-cover d-block pointer-events-none" width="801" height="807" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/footer-galaxy.webp"></img>
    <div className='flex items-center justify-center relative z-[2] mt-[-200px]'>
      <img alt="Gee Mobile developer workspace" width="801" height="807" className="pointer-events-none  w-[400px] object-cover h-[403px]" src="/hero-drone.png" />
    </div>
  </div>
  )
}
