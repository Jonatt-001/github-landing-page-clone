            ...
            <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#7ee787' direction='flex-col' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        ...
                        <div>
                            <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://geemobile.geefox.xyz/" className=' md:text-xl text-white font-semibold inline-block'>
                ...
                <HoverCard backgroundColor='#7ee787' direction='flex-col' left='-400px'>
                    <div className='md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        ...
                        <div>
                            <a onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://geemobile.geefox.xyz/" className=' md:text-xl text-white font-semibold inline-block'>
                                Get Gee Mobile
